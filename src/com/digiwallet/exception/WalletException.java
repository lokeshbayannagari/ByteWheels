...
public class WalletException extends Exception {
	...
	public static enum Codes {
		...
		CODE_NULL_ENTITY(500, "Entity not present"), CODE_INTERNAL_SYSTEM_ERROR(0,
		...
		// CODE_RESULTS_NOT_READY(9, "The paper is not yet evaluated. For results,
		...
		/*** Cards ******/
		CODE_CARDS_DUPLICATE_EMAILID(10012,
				"Email ID already exists in the system"), CODE_CARDS_DUPLICATE_EMAILID_IN_CURRENT_ORGANIZATION(10013,
						"Email ID already exists in the selected organization."), CODE_CARDS_FAILED_TO_UPDATE(10014,
								"Failed to update card."), CODE_CARDS_FAILED_TO_DELETE(10014, "Failed to delete card."),
		/* Date */
